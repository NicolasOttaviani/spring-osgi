...
//    }
    ...
    private void findSyntheticClassPathMatchingResource(Bundle bundle, String path, Collection<String> foundPaths)
        ...
        OsgiBundleResourcePatternResolver localPatternResolver = new OsgiBundleResourcePatternResolver(bundle, getClassLoader());
    ...
    private void findBundleClassPathMatchingFolders(List<String> list, Bundle bundle, String cpEntryPath, String pattern)
        ...
        OsgiBundleResourcePatternResolver localResolver = new OsgiBundleResourcePatternResolver(bundle, getClassLoader());
