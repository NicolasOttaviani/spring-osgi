...
/**
 * Utility class for OSGi {@link org.osgi.framework.Bundle}s. Provides convenience methods for
...
public abstract class OsgiBundleUtils {
     ...
     * @see org.osgi.framework.Constants#FRAGMENT_HOST
     */
     ...
     * @see org.osgi.framework.Constants#BUNDLE_VERSION
     */
    ...
    public static Version getHeaderAsVersion(Bundle bundle, String header) {
        Assert.notNull(bundle);
        return Version.parseVersion(bundle.getHeaders().get(header));
    }
}
