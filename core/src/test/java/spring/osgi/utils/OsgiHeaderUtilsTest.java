...
public class OsgiHeaderUtilsTest {
    ...
    private static final String PKG = "com.acme.facade";


    @Test
    public void testGetNoBundleClassPathDefined() {
        Properties props = new Properties();
        Bundle bundle = createMock(props);
    ...
    private Bundle createMock(Properties props) {
        Bundle bundle = mock(Bundle.class);

        Dictionary<String, String> headers = new Hashtable<>();
        for (final String name : props.stringPropertyNames())
            headers.put(name, props.getProperty(name));
